...
import Navbar from "../components/Navbar"; // Ubah impor Header menjadi Navbar
...
export default function LandingPagePage() {
  ...
  return (
    <div className="w-full bg-[#FFF5EC]">
      ...
      <Navbar />
      <div className="relative bottom-0 right-0 mb-10 w-[50%] md:w-full delicious-image flex ">
        <Img
      ...
      <div className="relative z-1 h-auto bg-[#FFF5EC] bg-cover bg-no-repeat pb-[164px] pl-[108px] pr-[115px] md:h-auto md:px-5 md:pb-5">
        <div className="flex flex-col items-start gap-10 md:w-full sm:w-full mt-[150px] md:mt-[100px] sm:mt-[50px]">
          <Heading size="md" as="h1" className="w-full capitalize leading-[90px] !text-indigo-900 md:leading-[70px] sm:leading-[50px]">
            <>
      ...
      <div className="relative flex flex-col justify-center bg-yellow-50">
        {searchBarValue2 ? (
              ...
              filteredRecipes.map((recipe) => (
                <Link href={`/detailresep/${recipe.id}`} key={recipe.id} className="relative h-[300px] w-[30%] sm:w-[48%] xs:w-full">
                  ...
                  <Text
                    size="3xl"
                    as="p"
                    className="absolute bottom-[8%] left-[8%] m-auto w-[22%] capitalize !text-[#FFF5EC] leading-[41px]"
                  >
                    {recipe.title}
                  </Text>
                </Link>
              ...
              <div className="flex w-full flex-col gap-[95px] md:gap-[71px] sm:gap-[47px]">
                ...
                <div className="flex items-center justify-between gap-5 md:flex-col">
                  <div className="relative h-[881px] w-[52%] md:w-full">
                    <div className="absolute left-[0.00px] top-[0.00px] m-auto h-[400px] w-[55%] bg-amber-400 md:h-[400px] md:w-[95%]" />
                    <Img
                      src="/images/img_rectangle_313.png"
                      width={300}
                      height={300}
                      alt="feature image"
                      className="absolute bottom-[0.00px] right-[0.00px] m-auto h-[800px] w-[800px] rounded-[15px] object-cover md:h-[400px] md:w-[400px]"
                    />
                  </div>
                  <div className="flex w-[32%] flex-col items-start md:w-full">
                    <Text size="6xl" as="p" className="w-full leading-[88px] md:leading-[70px] sm:leading-[50px]">
